<div align="center">
  ...
  [![Zed v1.2.7](https://img.shields.io/badge/Zed-v1.2.7-blue?logo=zedindustries&logoColor=white)](https://github.com/zed-industries/zed/releases/tag/v1.2.7)
...
uv run zed-i18n extract --zed-root .cache/zed/v1.2.7-clean-extract
uv run zed-i18n audit-candidates --zed-root .cache/zed/v1.2.7-clean-extract
uv run zed-i18n prepare-translation --language ko-KR --zed-root .cache/zed/v1.2.7-clean-extract
